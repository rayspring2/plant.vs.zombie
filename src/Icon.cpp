...
Icon :: Icon(int x, int y) {
    ...
    column = y;
    money = 50;
    items.push_back(new Item(0, 0, PEASHOOTER, 10, "files/pic/PeashooterMenu.png", 100));
    items.push_back(new Item(0, 60, SNOWPEA, 10, "files/pic/SnowpeaMenu.png", 175));
    items.push_back(new Item(0, 120, SUNFLOWER, 10, "files/pic/SunflowerMenu.png", 50));
    items.push_back(new Item(0, 180, WALNUT, 10, "files/pic/WalnutMenu.png", 50));
}
